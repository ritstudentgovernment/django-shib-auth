...
class ShibIgnoredGroupsMixin(models.Model):
	shib_ignored_groups = models.ManyToManyField(
		...
		blank=True,
		help_text='Groups that Shibboleth will ignore when adjusting '
			'this user\'s groups based on Affiliations. Add a group '
			'to prevent Shib from changing this user\'s membership in that group.',
